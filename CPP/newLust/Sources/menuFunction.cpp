...
#include "../Includes/menuFunction.h"
...
// MENU PRINCIPAL--------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    case 1:
    {
        printASCII(_binary_resources_embeded_file_txt_res_end, _binary_resources_embeded_file_txt_res_start, 1500);
