...
public:
    ...
    static void drawCircle(SDL_Renderer*renderer,SDL_Color color, int radius,int x,int y);

    static void drawCircunference(SDL_Renderer*renderer,SDL_Color color, int radius,int xCenter,int yCenter,int precision);
//
