...
#define GAME_SMOOTHNESS_FACTOR 1.0f
...
#define HYDRATIONCOUNTER ((int)(10*AGE_TICK_DURATION))



#define SLEEPING_ENERGY_SCORE (200.0f/AGE_TICK_DURATION)
#define SLEEPING_HUNGER_SCORE (10.0f/AGE_TICK_DURATION)
#define SLEEPING_THIRST_SCORE (10.0f/AGE_TICK_DURATION)


#define DIGESTION_HUNGER_SCORE (30.0f/AGE_TICK_DURATION)
#define DIGESTION_THIRST_SCORE (15.0f/AGE_TICK_DURATION)

#define HYDRATION_THIRST_SCORE (60.0f/AGE_TICK_DURATION)
...
#define ENERGYDECAY (12.0f/AGE_TICK_DURATION)
#define THIRSTDECAY (8.0f/AGE_TICK_DURATION)
#define HUNGERDECAY (4.0f/AGE_TICK_DURATION)
#define BOREDOMDECAY (10.0f/AGE_TICK_DURATION)
