...
int main(void)
{
    ...
    Temos por ex: 6. 6 é diferente de 1. Logo, o primeiro passo é, por ser par dividir por 2. Dá 3. Como 3 é ímpar, multiplicamos por 3 e somamos 1 e dividimos por 2. dá 5. 5é ímpar.
